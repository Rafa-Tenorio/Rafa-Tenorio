...
| 🗂️ Fluxo de Trabalho (Jira) | Gestão Ágil (Jira) | Organização de Sprint Backlog, escrita de User Stories e fluxo de testes (Scrum Board). | [🖼️ Ver Workflow](jira-board.png) |
